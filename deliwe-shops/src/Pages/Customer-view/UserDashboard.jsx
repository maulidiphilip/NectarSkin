...
import { Package, Heart, User, Settings, LogOut, Menu, X } from "lucide-react";
import ProfileSection from "@/components/user-dashboard/ProfileSection";
import OrdersSection from "@/components/user-dashboard/OrdersSection";
import WishlistSection from "@/components/user-dashboard/WishlistSection";
import SettingsSection from "@/components/user-dashboard/SettingsSection";
...
const UserDashboard = () => {
  ...
  const navItems = [
    ...
    { name: "Wishlist", icon: <Heart className="w-5 h-5" />, path: "wishlist" },
